...
@implementation FFmpegAudioEncode
...
//音频编码
+(void)ffmpegAudioEncode:(NSString*)jinFilePath outFilePath:(NSString*)joutFilePath
{
    /** 第一步：注册组件->音频编码器等等… */
    av_register_all();
    ...
    //打开音频输入文件
    const char *c_inFilePath = [jinFilePath UTF8String];

...
JNIEXPORT void JNICALL Java_yochi_com_yochi_1videodecoding_MainActivity_ffmpegVideoDecode(
        JNIEnv *env,
        jobject jobj,
        jstring jinFilePath,
...
Java_yochi_com_yochi_1videodecoding_MainActivity_stringFromJNI(
        JNIEnv *env,
        jobject /* this */);
}
...
Java_yochi_com_yochi_1videodecoding_MainActivity_stringFromJNI(
    ...
    __android_log_print(ANDROID_LOG_INFO,"main","Hello from C++");
...
Java_yochi_com_yochi_1videodecoding_MainActivity_ffmpegVideoDecode(
    ...
    if(avformat_open_input_result !=0) {
        // 0 成功 其他失败
        __android_log_print(ANDROID_LOG_INFO,"封装格式上下文打开文件","打开文件失败");
        return;
    }
    ...
    __android_log_print(ANDROID_LOG_INFO, "main", "解码器名称：%s", avcodec_avcodec->name);
    ...
    __android_log_print(ANDROID_LOG_INFO, "main", "解码完成");
    ...
    __android_log_print(ANDROID_LOG_INFO, "main", "释放完成");
